...
More recently, sonification can be considered as a complement to visualisation and to engage non-experts with data (Lenzi and Cuciarelli, 2019). This brings more of a design element to sonification to help the listener understand the data and to create different engagement with it. 
...
[<< Previous](listening)  [Next >>](design)